Public Class OnSale_Receipt_Register
    ...
    Private Sub txttoDate_Validating(sender As Object, e As System.ComponentModel.CancelEventArgs) Handles txtFromDate.Validating
    ...
    Private Sub retrive(Optional ByVal condtion As String = "")
        ...
        dt = clsFun.ExecDataTable("Select * FROM Vouchers Where EntryDate Between '" & CDate(txtFromDate.Text).ToString("yyyy-MM-dd") & "' And '" & CDate(txttoDate.Text).ToString("yyyy-MM-dd") & "' and transtype='On Sale Receipt' " & condtion & "  order by  InvoiceID,EntryDate ")
    ...
    Private Sub printRecord()
        ...
        For Each row As DataGridViewRow In dg1.Rows
            With row
                sql = sql & "insert into Printing(D1,D2, P1, P2,P3, P4, P5, P6,P7,P8,P9,P10,P11,P12,P13,P14,P15) values('" & txtFromDate.Text & "','" & txttoDate.Text & "'," & _
