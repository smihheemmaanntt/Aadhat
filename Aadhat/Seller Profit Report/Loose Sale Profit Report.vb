Public Class Loose_Sale_Profit_Report
    ...
    Private Sub RetriveChargeAlso(Optional ByVal condtion As String = "")
        ...
        ssql = "Select * From Vouchers  Where EntryDate between '" & CDate(txtfromDate.Text).ToString("yyyy-MM-dd") & "' and '" & CDate(txttoDate.Text).ToString("yyyy-MM-dd") & "' " & condtion & " and TransType='Purchase (Loose)'"
