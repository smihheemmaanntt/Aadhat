Public Class OutStanding
    ...
    Private Sub rowColums()
        ...
        dg1.Columns(2).Name = "Last Sale"
        dg1.Columns(2).Width = 300
        dg1.Columns(3).Name = "Last Receipt"
    ...
    Private Sub BtnPrint_Click(sender As Object, e As EventArgs) Handles BtnPrint.Click
        ...
        Else
            PrintRecord()
            If Application.OpenForms().OfType(Of OutStanding).Any = False Then Exit Sub
            Report_Viewer.printReport("\LastTransOutStanding.rpt")
    ...
    Private Sub btnPrintHindi_Click(sender As Object, e As EventArgs) Handles btnPrintHindi.Click
        ...
        Else
            PrintRecord()
            If Application.OpenForms().OfType(Of OutStanding).Any = False Then Exit Sub
            Report_Viewer.printReport("\LastTransOutStandingHindi.rpt")
            Report_Viewer.MdiParent = MainScreenForm
            Report_Viewer.Show()
            If Not Report_Viewer Is Nothing Then
                Report_Viewer.BringToFront()
