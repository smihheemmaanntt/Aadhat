...
Public Class Mobile_App
    ...
    Private Sub saveUpdateInfo()
        ...
        If ClsCommon.IsInternetConnect Then
            ...
            For Each item As DataRow In compdt.Rows
                ...
                companyRequest.PrintOtheraddress = Utf82Hebrew(item.Field(Of String)("PrintOtheraddress"))
                companyRequest.PrintOtherCity = Utf82Hebrew(item.Field(Of String)("PrintOtherCity"))
                companyRequest.PrintOtherName = Utf82Hebrew(item.Field(Of String)("PrintOtherName"))
                companyRequest.PrintOtherState = Utf82Hebrew(item.Field(Of String)("PrintOtherState"))
            ...
            Dim accSql As String = "Select * FROM Accounts Order by AccountName"
            ...
            For Each item As DataRow In accDt.Rows
                ...
                acc.OtherName = Utf82Hebrew(item.Field(Of String)("OtherName"))
            ...
            For Each item As DataRow In crateDt.Rows
                ...
                Crtgrp.MarkaName = item.Field(Of String)("MarkaName")
            ...
            For i As Integer = 0 To CratemaxRowCount - 1
                ...
                If CrateVDt.Rows.Count() > 0 Then
                    ...
                    For Each item As DataRow In CrateVDt.Rows
                        ...
                        CrateV.Remark = item.Field(Of String)("Remark")
    ...
    Private Sub CustomUpdate()
        ...
        If ClsCommon.IsInternetConnect Then
            ...
            ' '''' Crate Talbe Insert (Full Mathod)
    ...
    Private Sub Mobile_App_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If Not File.Exists(fileName) = True Then
            ...
            TxtAuthPathPassword.UseSystemPasswordChar = True
            ...
            If ledDt.Rows.Count() > 0 Then
                ...
                For Each item As DataRow In ledDt.Rows
                    ...
                    FastQuery = FastQuery & IIf(FastQuery <> "", " UNION ALL SELECT ", "") & item.Field(Of Int64)("AccountID") & "," & item.Field(Of Int64)("VourchersID") & "," &
                                ...
                                "'" & Utf82Hebrew(IIf(item.Field(Of String)("RemarkHindi") = Nothing, "", item.Field(Of String)("RemarkHindi"))) & "','" & item.Field(Of String)("Remark") & "'," & Val(OrgID) & ""
                Next
