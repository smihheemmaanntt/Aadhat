Public Class CustomerWiseSaleSummary
    ...
    Private Sub printRecord()
        ...
        For Each row As DataGridViewRow In dg1.Rows
            With row
                sql = sql & "insert into Printing(D1,D2,P1,P2, P3, P4,P5, P6, P7, P8,P9,P10,P11,P12,P13,P14,P15,P16,P17,P18,P19,P20,P21) values('" & txtFromDate.Text & "','" & txttoDate.Text & "'," & _
