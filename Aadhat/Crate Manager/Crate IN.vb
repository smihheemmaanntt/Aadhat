...
Public Class Crate_IN
    Dim vno As Integer : Dim VchId As Integer = 0
    Dim sql As String = String.Empty
    Dim bal As String = "" : Dim ServerTag As Integer
    ...
    Private Sub Crate_IN_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        If e.KeyCode = Keys.Escape Then
            ...
            ElseIf dgCrate.Visible = True Then
    ...
    End Sub
    Private Sub print()
        If clsFun.ExecScalarStr("Select AskReciept from Controls ") = "Crate" Then
            If MessageBox.Show("Are You Sure want to Print Crate in Slip ??", "Print Confirmation...", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                PrintRecord()
    ...
    Private Sub save()
        ...
        Try
            ...
            If cmd.ExecuteNonQuery() > 0 Then
                ...
                ledger() : CrateLedger() : ServerTag = 1 : ServerLedger() : ServerCrateLedger()
    ...
    Public Sub FillControls(ByVal id As Integer)
        ...
        ssql = "Select * from CrateVoucher where crateType='Crate In' and Voucherid=" & id
    ...
    Private Sub Delete()
        ...
        Try
            If MessageBox.Show("Are you Sure want to Delete Crate??", "Delete Entry", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2) = Windows.Forms.DialogResult.Yes Then
                ...
                End If
                MsgBox("Crate In Entry Deleted Successfully...", MsgBoxStyle.Information, "Crate In Deleted")
                Txtclear()
            End If
        Catch ex As Exception
            MsgBox(ex.Message)
    ...
    Private Sub txtMode_GotFocus(sender As Object, e As EventArgs) Handles txtCrateMarka.GotFocus
        ...
        txtCrateMarka.SelectionStart = 0 : txtCrateMarka.SelectionLength = Len(txtCrateMarka.Text)
    End Sub
    ...
    Private Sub LoadOfficialTemplateCombo()
        ...
        WhatsAppOfficialSendHelper.LoadOfficialTemplateCombo(cbOfficialTemplate, lblOfficialTemplate, "crate_in", preferredLanguage, Not RadioMsgOnly.Checked)
    End Sub
    ...
    Private Function BuildPhoneMsgBody(ByVal msgText As String, ByVal fileUrl As String) As String
        ...
        If fileUrl.Trim() <> "" Then
            ...
            Dim pdfLabel As String = If(btnRadioEnglish.Checked, "CRATE IN VIEW : ", "क्रेट जमा रसीद : ")
    ...
    Private Sub SendOfficialCrateInData()
        Dim directoryName As String = Application.StartupPath & "\Pdfs"
            ...
            With row
                ...
                If .Cells(0).Value = True AndAlso .Cells(3).Value <> "" Then
                    ...
                    If RadioMsgOnly.Checked Then
                        ok = WhatsAppOfficialSendHelper.SendAadhatText("crate_in", "CRATE_IN", mobile, .Cells(4).Value.ToString(), txtEntryDate.Text, "", msgText, apiResponse, If(btnRadioEnglish.Checked, "en", "hi"), "", SelectedOfficialTemplateCode())
                    Else
                        ok = WhatsAppOfficialSendHelper.SendAadhatDocument("crate_in", "CRATE_IN", mobile, .Cells(4).Value.ToString(), txtEntryDate.Text, "", fileUrl, WhatsAppOfficialApi.CleanDocumentName(GlobalData.PdfName, "Crate.pdf"), apiResponse, If(btnRadioEnglish.Checked, "en", "hi"), "", SelectedOfficialTemplateCode())
                    End If
