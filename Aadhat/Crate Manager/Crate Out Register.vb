...
Public Class Crate_Out_Register
    ...
    Private Sub ShowWhatsappContacts(Optional ByVal condtion As String = "")
        ...
        Dim i As Integer
        Dim count As Integer = 0
        Dim SSql As String = "Select *,sum(qty)  as TotQty FROM CrateVoucher WHERE EntryDate Between '" & CDate(txtFromDate.Text).ToString("yyyy-MM-dd") & "' and '" & CDate(txtToDate.Text).ToString("yyyy-MM-dd") & "' and Cratetype = 'Crate Out' and TransType<>'Op Bal' " & condtion & " Group by EntryDate,AccountID,CrateID Order by EntryDate,Upper(AccountName),upper(CrateName)"
