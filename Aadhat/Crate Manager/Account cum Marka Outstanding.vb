Public Class Account_cum_Marka_Outstanding
    ...
    Private Sub retriveAccounts(Optional ByVal condtion As String = "")
        ...
        dt = clsFun.ExecDataTable("Select AccountID,AccountName From CrateVoucher " & condtion & " Group By AccountName order by AccountName")
        Try
    ...
    Private Sub txtFromDate_GotFocus(sender As Object, e As EventArgs) Handles txtFromDate.GotFocus, txttoDate.GotFocus
                ...
                For i = 0 To dt.Rows.Count - 1
                    ...
                    With dg1.Rows(i)
                        ...
                        If i = 0 Then
                            ...
                            End If
                        Else
                            tot = tot + IIf(Val(.Cells(7).Value) > 0, Val(.Cells(7).Value), -Val(.Cells(8).Value))
                        End If
                        .Cells(9).Value = IIf(tot > 0, tot & " In", Math.Abs(tot) & " Out")
