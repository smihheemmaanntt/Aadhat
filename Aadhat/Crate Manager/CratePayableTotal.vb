...
Public Class CratePayableTotal
    ...
    Private Sub rowColums()
        ...
        dg1.Columns(6).Name = "Payable" : dg1.Columns(6).Width = 100
            ...
            If dt.Rows.Count > 0 Then
                ...
                For i = 0 To dt.Rows.Count - 1
                    ...
                    With dg1.Rows(i)
                        ...
                        .Cells(6).Value = Math.Abs(Val(dt.Rows(i)("Reciveable").ToString()))
    ...
    Private Sub BtnPrint_Click(sender As Object, e As EventArgs) Handles BtnPrint.Click
        PrintRecord()
        Report_Viewer.printReport("\Reports\CratePayable.rpt")
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        PrintRecord()
        Report_Viewer.printReport("\Reports\CratePayable2.rpt")
        Report_Viewer.MdiParent = MainScreenForm
        Report_Viewer.Show()
        If Not Report_Viewer Is Nothing Then
            Report_Viewer.BringToFront()
