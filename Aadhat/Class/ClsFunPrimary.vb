...
Public Class ClsFunPrimary
    Public Shared ConString As String = "Data Source=" & Application.StartupPath & "\Dbp.db;Version=3;New=True;Compress=True;synchronous=ON;"
