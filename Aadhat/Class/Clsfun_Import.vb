...
Public Class Clsfun_Import
    ...
    Public Shared Function GetConnection() As SQLiteConnection
        If (GlobalData.ConnectionPath).ToUpper = ("Data").ToUpper Then
            ...
            con.Open()
        Else
            Dim cs As String = "Data Source= " & GlobalData.ConnectionPath & ";Version=3;New=True;Compress=True;synchronous=ON;"
            con = New SQLiteConnection(cs)
            con.Open()
        End If
        Return con
    ...
    Public Shared Function Ledger(ByVal Opt As Integer, ByVal vchid As Integer, ByVal entryDt As String, ByVal TransType As String, ByVal Acid As Integer, ByVal AcName As String, ByVal Amt As Double, ByVal Dc As String, Optional ByVal Remarks As String = "", Optional ByVal Narration As String = "", Optional ByVal RemarkHindi As String = "") As Integer
        Ledger = 0
        ...
        If Opt = 0 Then
            sSql = "Insert into Ledger(VourchersID,EntryDate,TransType,AccountID,AccountName,Amount,DC,Remark,Narration,RemarkHindi)" & _
                " values(" & vchid & ",'" & entryDt & "','" & TransType & "'," & Acid & ",'" & AcName & "'," & Amt & ",'" & Dc & "','" & Remarks & "','" & Narration & "','" & RemarkHindi & "')"
